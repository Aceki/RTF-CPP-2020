...
double Math::Vector4D::dot(const Vector4D& vec1, const Vector4D& vec2)
{
	return vec1.m_x * vec2.m_x + vec1.m_y * vec2.m_y + vec1.m_z * vec2.m_z + vec1.m_t + vec2.m_t;
}

double Math::Vector4D::getLength() const 
{ 
...
Math::Vector4D Math::Vector4D::operator+(const Vector4D& vec) const 
{ 
...
Math::Vector4D Math::Vector4D::operator/(const double number) const
{
